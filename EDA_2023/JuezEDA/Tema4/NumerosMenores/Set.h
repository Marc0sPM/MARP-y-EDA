...
public:
    ...
    bool contains(T const& x) const { //O(log(n)) -> búsqueda binaria
        bool found;
        int pos;
    ...
    //El operator== va a ser O(n), solo hay que ver que los dos arrays sean iguales.
